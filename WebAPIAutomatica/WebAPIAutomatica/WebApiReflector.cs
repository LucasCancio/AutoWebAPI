...
{
    public class WebApiReflector
    {
        public string AssemblyName { get; }

        public WebApiReflector(string assemblyName)
        {
        ...
        public List<ApiMethod> GetApiMethods()
        {
            ...
            {
                var rpAttrib = c.GetCustomAttributes(typeof(System.Web.Mvc.RoutePrefixAttribute)).FirstOrDefault() as RoutePrefixAttribute;
