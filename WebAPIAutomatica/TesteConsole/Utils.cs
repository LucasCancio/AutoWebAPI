...
namespace TesteConsole
{
    public static class Utils
    {
        ...
        public static File FileCreateFromSaveDialog(Solution mSolution, string fileName= "ClasseTeste")
        {
            ...
            var templateFile = new File(mSolution, fileName);
        ...
        public static string CSProjectFromOpenDialog()
        {
            ...
            return @"C:\Users\Lucas\Desktop\WorkspaceV\WebAPIAutomatica\ProjetoTeste\ProjetoTeste.csproj";
        }
    }
}
